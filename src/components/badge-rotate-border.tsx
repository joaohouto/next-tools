...
export function BadgeRotateBorder({
  ...
  return (
    <div className={"relative inline-flex overflow-hidden rounded-full p-px"}>
      ...
      <span
        className={cn(
          "inline-flex h-full w-full items-center justify-center rounded-full bg-neutral-100 px-3 py-1 text-xs font-medium text-neutral-500 backdrop-blur-3xl dark:bg-neutral-950 dark:text-neutral-100",
          className
        )}
      >
        {children}
