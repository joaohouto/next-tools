...
export function VectorizeView({
  ...
  useEffect(() => {
    if (dataUrlRef.current) doVectorize(dataUrlRef.current, debouncedThreshold);
      ...
      <ControlsBar>
        ...
        <div className="flex gap-2">
          ...
          <Button
            ...
            size="sm"
            onClick={copy}
            disabled={!svg || processing}
          >
            <Copy size={14} /> Copiar SVG
          </Button>
          <Button size="sm" onClick={download} disabled={!svg || processing}>
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="flex flex-col gap-2">
            ...
            <div className="rounded-xl overflow-hidden border bg-muted/30">
              <img src={img.src} alt="Original" className="w-full h-auto" />
            </div>
          </div>
          <div className="flex flex-col gap-2">
